...
function(
	 ...
	 */
	BaseUI.prototype.openModal = function(module, action, parameters, options) {
	 ...
	 */
	BaseUI.prototype.showModal = function(content, options, readyCallback) {
		var self = this,
	 ...
	 * @method hideModal
	 */
	BaseUI.prototype.hideModal = function() {
		$('#modal').modal('hide');
	};
